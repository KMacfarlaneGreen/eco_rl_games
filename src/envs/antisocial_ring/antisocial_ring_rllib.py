...
class AntisocialRingEnv(MultiAgentEnv):
    ...
    def __init__(self, num_agents, graph_size):
        super().__init__()
        ...
        self.truncateds = set()
        self.observation_space = gym.spaces.Box(low=np.zeros((3)), high = self.graph_size*np.ones((3)), dtype=np.float32)
    ...
    def step(self, action_dict):
        ...
        #update agent fov
            ...
            return observations, self.rewards, terminations, infos
